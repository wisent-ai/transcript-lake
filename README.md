...
See [the core workflow contract](https://transcript-lake.wisent.com/docs/core/) and [the data and architecture contract](https://transcript-lake.wisent.com/docs/lake/) for state transitions, schemas, masking behavior, paths, and recovery semantics.
...
Continue with the [CLI tour](https://transcript-lake.wisent.com/docs/examples/core/cli-tour/), [full onboarding guide](https://transcript-lake.wisent.com/docs/onboarding/), and [canonical examples catalog](https://transcript-lake.wisent.com/docs/examples/).
...
- **Upgrades:** use an immutable release once available. State layout compatibility, rollback, and release channels are defined in the [release policy](https://transcript-lake.wisent.com/docs/releases/).
...
- **Integrations:** capability, dependency, failure, and removal contracts are in the [integration contracts](https://transcript-lake.wisent.com/docs/integrations/).
